"""Tests for editor/navigation_highlight.py."""

from editor.navigation_highlight import NavigationHighlight
...
def test_apply_highlight_rebuilds_iters_from_offsets(monkeypatch):
    ...
    monkeypatch.setattr("editor.navigation_highlight.get_theme", lambda: type("T", (), {"accent_color": "#112233"})())
    monkeypatch.setattr("editor.navigation_highlight.GLib.timeout_add", lambda *_args, **_kwargs: 1)
