...
_FILE_ICON_MAP = {
    ...
    ".htm": Icons.FILE_HTML,
    ".css": Icons.FILE_CSS,
    ".scss": Icons.FILE_SCSS,
    ".sass": Icons.FILE_SASS,
    ".less": Icons.FILE_LESS,
    ".json": Icons.FILE_JSON,
    ".yaml": Icons.FILE_YAML,
    ".yml": Icons.FILE_YAML,
    ".xml": Icons.FILE_XML,
    ".md": Icons.FILE_MD,
    ".markdown": Icons.FILE_MD,
    ".rs": Icons.FILE_RUST,
    ".go": Icons.FILE_GO,
    ...
    ".php": Icons.FILE_PHP,
    ".sh": Icons.FILE_SHELL,
    ".bash": Icons.FILE_SHELL,
    ".zsh": Icons.FILE_SHELL,
    ".fish": Icons.FILE_SHELL,
    ".c": Icons.FILE_C,
    ".h": Icons.FILE_C,
    ".cpp": Icons.FILE_CPP,
    ".hpp": Icons.FILE_CPP,
    ".cs": Icons.FILE_CSHARP,
    ".swift": Icons.FILE_SWIFT,
    ".kt": Icons.FILE_KOTLIN,
    ".scala": Icons.FILE_SCALA,
    ".r": Icons.FILE_R,
    ".jl": Icons.FILE_JULIA,
    ".lua": Icons.FILE_LUA,
    ".vim": Icons.FILE_VIM,
    ".sql": Icons.FILE_SQL,
    ".graphql": Icons.FILE_GRAPHQL,
    ".docker": Icons.FILE_DOCKER,
    ".dockerfile": Icons.FILE_DOCKER,
    ".toml": Icons.FILE_TOML,
    ".ini": Icons.FILE_INI,
    ".cfg": Icons.FILE_INI,
    ".conf": Icons.FILE_INI,
    ".env": Icons.FILE_ENV,
    ".gitignore": Icons.FILE_GITIGNORE,
    ".dart": Icons.FILE_DART,
    ".vue": Icons.FILE_VUE,
    ".svelte": Icons.FILE_SVELTE,
    ...
    ".pdf": Icons.FILE_PDF,
    ".zip": Icons.FILE_ARCHIVE,
    ".tar": Icons.FILE_ARCHIVE,
    ".gz": Icons.FILE_ARCHIVE,
    ".zen_sketch": Icons.FILE_SKETCH,
}

_FILE_NAME_MAP = {
    "dockerfile": Icons.FILE_DOCKER,
    "makefile": Icons.FILE_MAKEFILE,
    "cmakelists.txt": Icons.FILE_MAKEFILE,
    "license": Icons.FILE_LICENSE,
    ".gitignore": Icons.FILE_GITIGNORE,
    ".env": Icons.FILE_ENV,
}
...
def get_file_icon(file_path: str) -> tuple[str, str]:
    ...
    for ws_ext in WORKSPACE_EXTENSIONS:
        if basename.endswith(ws_ext):
            return Icons.FILE_WORKSPACE, ICON_COLORS.get("default", "#6d8086")

    icon = _FILE_NAME_MAP.get(basename, _FILE_ICON_MAP.get(ext, Icons.FILE_DEFAULT))
...
def create_icon_label(icon: str, size_pt: int | None = None) -> Gtk.Label:
    ...
    ----------
    icon:
        A single Unicode/Nerd-Font character (use an ``Icons.*`` constant).
    size_pt:
