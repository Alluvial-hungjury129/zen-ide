...
from icons import IconsManager, apply_icon_font, get_icon_font_name
...
class ActivityRendererMixin:
    ...
    def _setup_ui(self):
        ...
        search_icon = Gtk.Label(label=IconsManager.SEARCH)
        ...
        filter_options = [
            ("All", None, None),
            ("PRs", {"github_pr"}, IconsManager.GIT_MERGE),
            ("Notes", {"note"}, IconsManager.PIN),
            ("Sketches", {"sketch"}, IconsManager.PENCIL),
        ]
        ...
        # Add Note button
        self.add_note_btn = ZenButton(icon=IconsManager.PLUS, label="Note")
        ...
        # Add Sketch button
        self.add_sketch_btn = ZenButton(icon=IconsManager.PLUS, label="Sketch")
        ...
        # Refresh PRs button
        self.refresh_prs_btn = ZenButton(icon=IconsManager.GIT_MERGE, label="Refresh PRs")
    ...
    def _create_activity_row(self, activity: DevPadActivity) -> Gtk.Box:
        ...
        del_icon = Gtk.Label(label=IconsManager.CLOSE)
