...
class ZenIDEApp(Gtk.Application):
    ...
    def do_activate(self):
        ...
        """
        # Import here to avoid circular import — zen_ide imports zen_ide_app,
        # and ZenIDEWindow is defined in zen_ide_window.
        ...
        if is_first_launch:
            ...
            zen_ide_window._STARTUP_TIME = time.monotonic()
            win = zen_ide_window.ZenIDEWindow(self)
            ...
            GLib.idle_add(zen_ide_window._run_startup_housekeeping)
