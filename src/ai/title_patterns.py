"""Title pattern matching logic for AI tab title inference.

Split from ``tab_title_inferrer.py`` — no behavioural changes.
"""
...
def try_semantic_patterns(text: str) -> Optional[str]:
...
def process_message(text: str) -> str:
    ...
    semantic_title = try_semantic_patterns(text_clean)
    if semantic_title:
    ...
    return build_title(filtered, has_action_verb)


def build_title(words: list, has_action_verb: bool) -> str:
